...
from events.views import show_event, dashboard_view, add_event, all_events, search_events, edit_event, delete_event, participant_list, add_participant, edit_participant, delete_participant
